...
export const metadata: Metadata = {
  title: "All Tools",
  description: "Browse 130 free browser-based utilities for students, PDFs, images, writing, development and everyday work.",
  alternates: { canonical: "/tools" },
  openGraph: {
    title: "Browse 130 Free Online Tools | AllToolkit",
    ...
    <main className="mx-auto min-h-screen max-w-7xl px-5 py-16 sm:px-6 sm:py-20">
      <div className="mb-12 max-w-3xl">
        ...
        <p className="mt-5 text-lg leading-8 text-[#6B5B4D]">
          Search or filter 130 private, browser-based tools. PDF, student, image, writing, developer and calculator utilities are grouped clearly.
        </p>
      </div>
      <ToolLibrary />
    </main>
